...
public class InvoicesStudentCtrlTableModel extends AbstractTableModel  {

	private List<Invoice> invoices;
	private String[] colunas = new String[] { "Vencimento", "Valor",
			"Pagamento", "Cancelamento" };

	public InvoicesStudentCtrlTableModel(List<Invoice> invoices) {
		this.invoices = invoices;
	}

	public InvoicesStudentCtrlTableModel() {
